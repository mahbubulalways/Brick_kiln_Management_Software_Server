...
exports.sendSmsToPhoneNumbers = void 0;
...
const getMramErrorMessage = (error) => {
    const responseData = error?.response?.data;
    const errorCode = typeof responseData === "string"
...
const formatBangladeshPhoneNumbers = (phones) => {
    return phones
        .map((phone) => {
...
const sendSmsToPhoneNumbers = async (phoneNumber, message) => {
...
exports.sendSmsToPhoneNumbers = sendSmsToPhoneNumbers;
