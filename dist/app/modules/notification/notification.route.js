...
router.patch("/update/:id", (0, AuthGuard_1.default)(enums_1.UserRole.ADMIN, enums_1.UserRole.MANAGER, enums_1.UserRole.OWNER), SubscriptionGuard_1.default, notification_controller_1.NotificationController.updateNotification);
