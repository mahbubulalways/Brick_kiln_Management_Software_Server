...
router.get(api_endpoints_1.API_ENDPOINTS.INVOICE.GET_ADVANCE_INVOICE, ActiveSeasonGuard_1.default, (0, AuthGuard_1.default)(enums_1.UserRole.OWNER, enums_1.UserRole.ADMIN, enums_1.UserRole.MANAGER), challan_controller_1.InvoiceController.getAllAdvanceInvoiceController);
...
// UPDATE INVOICE
router.patch(api_endpoints_1.API_ENDPOINTS.INVOICE.UPDATE_INVOICE, (0, AuthGuard_1.default)(enums_1.UserRole.OWNER, enums_1.UserRole.ADMIN, enums_1.UserRole.MANAGER), challan_controller_1.InvoiceController.updateInvoiceController);
// UPDATE INVOICE DELIVERY DATE
router.patch(api_endpoints_1.API_ENDPOINTS.INVOICE.UPDATE_INVOICE_DELIVERY_DATE, (0, AuthGuard_1.default)(enums_1.UserRole.OWNER, enums_1.UserRole.ADMIN, enums_1.UserRole.MANAGER), challan_controller_1.InvoiceController.updateInvoiceDeliveryDateController);
// UPDATE INVOICE ITEM DELIVERY DATE
router.patch(api_endpoints_1.API_ENDPOINTS.INVOICE.UPDATE_INVOICE_ITEM_DELIVERY_DATE, (0, AuthGuard_1.default)(enums_1.UserRole.OWNER, enums_1.UserRole.ADMIN, enums_1.UserRole.MANAGER), challan_controller_1.InvoiceController.updateInvoiceItemDeliveryDateController);
// DELETE INVOICE
router.patch(api_endpoints_1.API_ENDPOINTS.INVOICE.DELETE_INVOICE, (0, AuthGuard_1.default)(enums_1.UserRole.OWNER, enums_1.UserRole.ADMIN, enums_1.UserRole.MANAGER), challan_controller_1.InvoiceController.deleteInvoiceController);
