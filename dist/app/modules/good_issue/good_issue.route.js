...
router.post("/create", (0, AuthGuard_1.default)(enums_1.UserRole.OWNER, enums_1.UserRole.ADMIN, enums_1.UserRole.MANAGER), uploader_1.fileUploader.upload.single("file"), good_issue_controller_1.GoodIssueController.createGoodIssueController);
