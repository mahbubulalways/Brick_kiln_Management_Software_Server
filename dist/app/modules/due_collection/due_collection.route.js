...
router.post(api_endpoints_1.API_ENDPOINTS.DUE_COLLECTION.COLLECTION, (0, AuthGuard_1.default)(enums_1.UserRole.OWNER, enums_1.UserRole.ADMIN, enums_1.UserRole.MANAGER), SubscriptionGuard_1.default, ActiveSeasonGuard_1.default, due_collection_controller_1.DueCollectionController.collectionNewDueController);
...
router.patch(api_endpoints_1.API_ENDPOINTS.DUE_COLLECTION.UPDATE_DUE_COLLECTION, (0, AuthGuard_1.default)(enums_1.UserRole.OWNER, enums_1.UserRole.ADMIN, enums_1.UserRole.MANAGER), SubscriptionGuard_1.default, due_collection_controller_1.DueCollectionController.updateDueCollectionController);
router.patch(api_endpoints_1.API_ENDPOINTS.DUE_COLLECTION.UPDATE_DUE_COLLECTION_DATE, (0, AuthGuard_1.default)(enums_1.UserRole.OWNER, enums_1.UserRole.ADMIN, enums_1.UserRole.MANAGER), SubscriptionGuard_1.default, due_collection_controller_1.DueCollectionController.updateDueCollectionDateController);
