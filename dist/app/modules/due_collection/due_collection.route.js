...
router.get(api_endpoints_1.API_ENDPOINTS.DUE_COLLECTION.TODAYS_HAVE_DUE, (0, AuthGuard_1.default)(enums_1.UserRole.OWNER, enums_1.UserRole.ADMIN, enums_1.UserRole.MANAGER), due_collection_controller_1.DueCollectionController.todayPayDueController);
router.get(api_endpoints_1.API_ENDPOINTS.DUE_COLLECTION.TODAY_PAID, (0, AuthGuard_1.default)(enums_1.UserRole.OWNER, enums_1.UserRole.ADMIN, enums_1.UserRole.MANAGER), due_collection_controller_1.DueCollectionController.getTodaysDuePaidController);
router.get(api_endpoints_1.API_ENDPOINTS.DUE_COLLECTION.ALL_DUE, (0, AuthGuard_1.default)(enums_1.UserRole.OWNER, enums_1.UserRole.ADMIN, enums_1.UserRole.MANAGER), due_collection_controller_1.DueCollectionController.getAllDueListController);
