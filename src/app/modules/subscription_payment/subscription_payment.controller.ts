...
const createNewSubscriptionPaymentController = catchAsync(async (req, res) => {
...
const getAllSubscriptionPaymentController = catchAsync(async (req, res) => {
  const result =
...
const getAllPaidSubscriptionController = catchAsync(async (req, res) => {
  const result =
...
const getOtherSubscriptionController = catchAsync(async (req, res) => {
  const result = await SubscriptionPaymentService.getOtherSubscriptionService();
