...
// CREATE LOAD INFO
const createLoadInfoService = async (payload: TLoadInfo) => {
...
// GET ALL LOAD INFO
const getAllLoadInfoService = async (query: TQuery) => {
...
const getSingleLoadInfoService = async (id: number) => {
...
// DELETE LOAD INFO
const deleteLoadInfoService = async (id: number) => {
