...
const getAllGoodCategoryController = catchAsync(async (req, res) => {
  const user = req.user as TAuthUser;
  const result = await GoodsCategoryService.getGoodCategoryService(user);
...
const getGoodCategoryOptionsController = catchAsync(async (req, res) => {
  const user = req.user as TAuthUser;
  const result = await GoodsCategoryService.getGoodCategoryService(user);
...
const getSingleGoodCategoryController = catchAsync(async (req, res) => {
  const { id } = req.params;
  const user = req.user as TAuthUser;
  const result = await GoodsCategoryService.getSingleGoodCategoryService(
    user,
    id,
  );
  if (!result) {
...
const updateGoodCategoryController = catchAsync(async (req, res) => {
  const { id } = req.params;
  const { body } = req;
  const user = req.user as TAuthUser;
...
const deleteGoodCategoryController = catchAsync(async (req, res) => {
  const { id } = req.params;
