...
const createGoodCategoryService = async (user: TAuthUser, payload: GoodsStockCategory) => {
...
const updateGoodCategoryService = async (user: TAuthUser, id: string, payload: GoodsStockCategory) => {
