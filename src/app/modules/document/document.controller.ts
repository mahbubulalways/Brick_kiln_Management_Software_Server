...
const createFolderController = catchAsync(async (req, res) => {
  ...
  const result = await DocumentService.createFolderService(user, req.body);
  ...
  if (result) {
    ...
    throw new AppError(StatusCodes.NOT_FOUND, "ফোল্ডার তৈরি করা যায়নি।");
  }
});
...
const getSingleFolderController = catchAsync(async (req, res) => {
  ...
  const result = await DocumentService.getSingleFolderService(user, id);
...
const uploadDocumentController = catchAsync(async (req, res) => {
  ...
  const result = await DocumentService.uploadDocumentService(user, req);
  ...
  if (result) {
    ...
    throw new AppError(StatusCodes.BAD_REQUEST, "ফাইল আপলোড করা যায়নি।");
  }
});
...
const deleteDocumentController = catchAsync(async (req, res) => {
  ...
  const result = await DocumentService.deleteDocumentService(user, id);
...
const deleteFolderController = catchAsync(async (req, res) => {
  ...
  const result = await DocumentService.deleteFolderService(user, id);
